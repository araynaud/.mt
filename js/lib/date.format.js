...
Date.formatDateRange = function(from, to, dateOnly)
{
	...
	var from;
	if(dateRange.dFrom)
		from=dateFormat(dateRange.dFrom, "longDate", true);
	if(!dateRange.duration)
		return from;
	var to=dateFormat(dateRange.dTo, "longDate", true);
...
{
//	var dateRange= Date.dateRange(from, to, dateOnly);
	var unit = dateFormat.i18n.units ? dateFormat.i18n.units[dateRange.unit] : dateRange.unit;
...
Date.formatTimeSince = function(since, dateOnly)
{
	...
	var fmt = dateFormat.i18n.sinceFormat;
