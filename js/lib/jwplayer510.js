    ...
    (function(b) {
        ...
        b.utils.stretch = function(k,q,p,g,n,h) {
            ...
            switch(k.toUpperCase()) {
                case b.utils.stretching.NONE:c.width = n;
                c.height = h;
                c.top = (g - c.height)/2;c.left=(p-c.width)/2;
                break;
                case b.utils.stretching.UNIFORM:if(d > f) {
                    c.width = n * f;
                    c.height = h * f;
                    if(c.width/p > 0.95) {
                        e = true;
                    ...
                    if(c.height/g > 0.95) {
                        e = true;
                        d = 1;
                        f = Math.ceil(100 * g/c.height)/100;c.height=g}}c.top=(g-c.height)/2;
                        c.left = (p - c.width)/2;break;case b.utils.stretching.FILL:if(d>f){c.width=n*d;c.height=h*d}else{c.width=n*f;c.height=h*f}c.top=(g-c.height)/2;
                        c.left = (p - c.width)/2;
                        break;
                ...
                b.utils.deepReplaceKeyName = function(k,e,c) {
                    switch(b.utils.typeOf(k)) {
                        case"array":for(var g=0;g<k.length;g++) {
                            k[g] = b.utils.deepReplaceKeyName(k[g],e,c)
                        }
                        break;
                        case"object":for(var f in k) {
                            var j
                            ,h;if(e instanceof Array && c instanceof Array) {
        ...
        (function(c) {
            ...
            function a(f) {
                switch(f.toLowerCase()) {
                    case"blue":return parseInt("0000FF",16);
            ...
            function a(d) {
                ...
                for(var c=0;c<d.childNodes.length;c++) {
                    ...
                    switch(b.utils.parsers.localName(d.childNodes[c]).toLowerCase()) {
                        case"enclosure":e.file = b.utils.strings.xmlAttribute(d.childNodes[c],"url");
                        break;
            ...
            a.plugins.plugin = function(b) {
                ...
                function e() {
                    switch(a.utils.getPluginPathType(b)) {
                        case a.utils.pluginPathType.ABSOLUTE:return b;
                ...
                this.getFlashPath = function() {
                    if(k) {
                        switch(a.utils.getPluginPathType(k)) {
                            case a.utils.pluginPathType.ABSOLUTE:return k;
                            case a.utils.pluginPathType.RELATIVE:if(b.lastIndexOf(".swf") > 0) {
                                return a.utils.getAbsolutePath(k,window.location.href)
                            }
                            return a.utils.getAbsolutePath(k,e());
                            case a.utils.pluginPathType.CDN:if(k.indexOf("-") >  - 1) {
                                return k + "h"
                            }
                            return k + "-h"
                        }
        ...
        (function(e) {
            ...
            function f(l) {
                ...
                switch(k.typeOf(l.plugins)) {
                    case"object":for(var n in l.plugins) {
        ...
        (function(a) {
            ...
            a.html5.view = function(n,H,h) {
                ...
                function p(U) {
                    ...
                    switch(U.newstate) {
                        case a.api.events.state.PLAYING:if(j.getMedia() && j.getMedia().hasChrome()) {
                ...
                function M(U) {
                    switch(U.keyCode) {
                        case 27:if(m.jwGetFullscreen()) {
                            m.jwSetFullscreen(false)
                        }
                        break;
                        case 32:if(m.jwGetState() != a.api.events.state.IDLE && m.jwGetState() != a.api.events.state.PAUSED) {
                            m.jwPause()
                        } else {
                            m.jwPlay()
                        }
                ...
                function G(U,ad) {
                    ...
                    if( ! j.fullscreen) {
                        ...
                        if(typeof U == "string" && U.indexOf("%") > 0) {
                            g = d.getElementWidth(d.parentNode(R)) * parseInt(U.replace("%"),"")/100}else{g=U}if(typeof ad=="string"&&ad.indexOf("%")>0){t=d.getElementHeight(d.parentNode(R))*parseInt(ad.replace("%"),"")/100
                        } else {
                            t = ad
                        }
                        var Y =  {
                ...
                var z = this.getComponentPosition = function(V) {
                    ...
                    switch(U.toUpperCase()) {
                        case a.html5.view.positions.TOP:W.top = d.parseDimension(o.style.top);
                ...
                this.resize = G;
                var J,k
                ,Q;var C = this.fullscreen = function(W) {
                    if(c) {
                        return
                    }
                    var Y;
        ...
        (function(a) {
            ...
            a.html5.controlbar = function(m,Y) {
                ...
                var l = m;
                var D = _utils.extend({}
                ,b,l.skin.getComponentSettings("controlbar"),Y);
                ...
                function Z(an) {
                    ...
                    if(D.position == a.html5.view.positions.OVER || l.jwGetFullscreen()) {
                        switch(l.jwGetState()) {
                            case a.api.events.state.PAUSED:case a.api.events.state.IDLE:if(ag && ag.style.opacity < 1 && ( ! D.idlehide || _utils.exists(an))) {
                                e = false;
                                setTimeout(function() {
                                    if( ! e) {
                                        X()
                ...
                function C(ar,au,aw) {
                    ...
                    switch(ar.name) {
                        case"play":y("playButton",au,false,aw);
                ...
                function o() {
                    ...
                    var at
                    ,aq;for(var ap=0;ap<an.length;ap++) {
            ...
            b.html5.controller = function(o,K,f,h) {
                ...
                function e() {
                    try {
                        if(m.playlist[m.item].levels[0].file.length > 0) {
                            switch(m.state) {
                                case b.api.events.state.PLAYING:case b.api.events.state.BUFFERING:if(m.getMedia()) {
                                    m.getMedia().pause()
                                }
                                break;
                                default:if(A) {
                ...
                function z(T) {
                    try {
                        if(m.playlist[m.item].levels[0].file.length > 0) {
                            ...
                            switch(m.state) {
                                case b.api.events.state.IDLE:if(G < 0) {
                ...
                function E() {
                    ...
                    switch(m.config.repeat.toUpperCase()) {
                        case b.html5.controller.repeatoptions.SINGLE:F();
                        break;
                        case b.html5.controller.repeatoptions.ALWAYS:if(m.item == m.playlist.length - 1 &&  ! m.config.shuffle) {
                            H(0)
                        } else {
                            k()
                        }
                        break;
                        case b.html5.controller.repeatoptions.LIST:if(m.item == m.playlist.length - 1 &&  ! m.config.shuffle) {
                            w();
                            v(0)
                        } else {
                            k()
        ...
        (function(a) {
            ...
            a.html5.display = function(k,K) {
                ...
                var m;
                var y
                ,R;var L = new a.html5.eventdispatcher();
                ...
                function U(Y) {
                    ...
                    _css(W.display_icon, {
                        ...
                        ,top:(h.skin.getSkinElement("display","background").height - h.skin.getSkinElement("display",Y).height)/2,left:(h.skin.getSkinElement("display","background").width-h.skin.getSkinElement("display",Y).width)/2
                    });
                    b();
                ...
                function t(Y) {
                    ...
                    switch(Y) {
                        case a.api.events.state.BUFFERING:if(_utils.isIPod()) {
                            I();
                            F()
                        } else {
                        ...
                        break;
                        case a.api.events.state.PAUSED:if( ! _utils.isIPod()) {
                            if(h.jwGetPlaylist()[h.jwGetPlaylistIndex()].provider != "sound") {
                                _css(W.display_image, {
                        ...
                        break;
                        case a.api.events.state.IDLE:if(h.jwGetPlaylist()[h.jwGetPlaylistIndex()] && h.jwGetPlaylist()[h.jwGetPlaylistIndex()].image) {
                            x()
                        } else {
                            I()
                        }
                        ...
                        O = true;
                        break;
                        default:if(h.jwGetPlaylist()[h.jwGetPlaylistIndex()] && h.jwGetPlaylist()[h.jwGetPlaylistIndex()].provider == "sound") {
                            if(_utils.isIPod()) {
                                I();
                                O = false
                            } else {
            ...
            a.html5.dock = function(w,D) {
                ...
                function l(H,T) {
                    ...
                    if(A.length > 0) {
                        ...
                        var M = H - O - I;
                        var R
                        ,L;if(n.align == a.html5.view.positions.LEFT) {
                            P = 1;
                            M = I
                        }
                ...
                function B(H) {
                    ...
                    if(D.position == a.html5.view.positions.OVER || w.jwGetFullscreen()) {
                        switch(w.jwGetState()) {
                            case a.api.events.state.PAUSED:case a.api.events.state.IDLE:if(r && r.style.opacity < 1 && ( ! D.idlehide || c.exists(H))) {
                                E()
                            }
                            if(D.idlehide) {
            ...
            a.html5.instream = function(y,m,x,z) {
                ...
                function p() {
                    ...
                    if(l) {
                        ...
                        _css(l.getDisplayElement(),b.extend({}
                        ,L, {
                            zIndex:1001
                            ,opacity:1
                        }))
                    ...
                    if(q) {
                        ...
                        _css(q.getDisplayElement(),b.extend({}
                        ,K, {
                            zIndex:1000
                        }))
                    }
                ...
                this.jwSeek = function(K) {
                    switch(A.controlbarseekable.toLowerCase()) {
                        case"always":this.jwInstreamSeek(K);
                        break;
                        case"backwards":if(_fakemodel.position > K) {
        ...
        (function(b) {
            ...
            function y(X) {
                ...
                if(a) {
                    switch(X) {
                        case b.api.events.state.PLAYING:S();
                        break;
            ...
            function G(Z) {
                ...
                if(f.exists(Z) && Z.lengthComputable && Z.total) {
                    Y = Z.loaded/Z.total*100}else{if(f.exists(o.buffered)&&(o.buffered.length>0)){var X=o.buffered.length-1;if(X>=0){Y=o.buffered.end(X)/o.duration * 100
                }
            }
        }
    ...
    function Q(Y) {
            ...
            if(z > 0) {
                if( ! isNaN(Y.target.duration) && (isNaN(l.duration) || l.duration < 1)) {
                    if(Y.target.duration == Infinity) {
                        ...
                        l.duration = Math.round(Y.target.duration * 10)/10}}}if(!F&&o.readyState>0){y(b.api.events.state.PLAYING)}if(h==b.api.events.state.PLAYING){if(o.readyState>0&&(P>-1||!F)){F=true;try{if(o.currentTime!=P&&P>-1){o.currentTime=P;P=-1}}catch(X){}o.volume=l.volume/100;
                        o.muted = l.mute
                    }
        ...
        function q(Z) {
            ...
            if((Z.target.error && Z.target.tagName.toLowerCase() == "video") || Z.target.parentNode.error && Z.target.parentNode.tagName.toLowerCase() == "video") {
                ...
                switch(X.code) {
                    case X.MEDIA_ERR_ABORTED:f.log("User aborted the video playback.");
                    return;
...
(function(jwplayer) {
    ...
    jwplayer.html5.model = function(api,container,options) {
        ...
        function forward(evt) {
            switch(evt.type) {
                case jwplayer.api.events.JWPLAYER_MEDIA_LOADED:_container = _media.getDisplayElement();
                break;
        ...
        _model.setActiveMediaProvider = function(playlistItem) {
            ...
            if( ! jwplayer.utils.exists(_mediaProviders[provider])) {
                switch(provider) {
                    case"video":_media = new jwplayer.html5.mediavideo(_model,current?current:_container);
                    break;
...
(function(a) {
    ...
    a.html5.playlistcomponent = function(r,C) {
        ...
        ,c,x.skin.getComponentSettings("playlist"),C);
        ...
        function j() {
            ...
            switch(e.position) {
                case a.html5.view.positions.RIGHT:case a.html5.view.positions.LEFT:y.style.width = e.size + "px";
                break;
        ...
        function q(J) {
            ...
            if(w() && (Q.image || Q["playlist.image"] || h.itemImage)) {
                G.className = "image";
                if(h.itemImage) {
                    L = (e.itemheight - h.itemImage.height)/2;M=h.itemImage.width;N=h.itemImage.height}else{M=e.itemheight*4/3;
                    N = e.itemheight
                }
                _css(K, {
                    height:N
        ...
        function m() {
            if(e.position == a.html5.view.positions.OVER) {
                switch(x.jwGetState()) {
                    case a.api.events.state.IDLE:_show(y);
                    break;
                    default:_hide(y);
                    break
                }
